...
export default defineConfig({
  lang: 'en-US',
  title: 'DirectX Guide',
  description: 'A modern guide to DirectX/Direct3D (with Rust as the source language), along with a collection of modern graphics topics/examples.',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/realandrew/directx_guide' }
    ]
  }
})